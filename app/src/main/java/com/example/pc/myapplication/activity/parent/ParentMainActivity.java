...
public class ParentMainActivity extends FragmentActivity implements
  ...
  private void initView() {
    ...
    seedInfoView = new SeedInfoView(ParentMainActivity.this);
    ...
    if (isInit) {
      ...
      seedInfoRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
        ...
        public void onRefresh() {
          ...
          for(String s :set) {
            map.put(AppConstant.USERNAME, s);
          }
          HttpService.DoGetDonateDataRequest(map, ParentMainActivity.this);
        }
      });
      isInit = false;
    }
  ...
  @Override
  public void OnGetSeedInfoFailedResponse(String errorResult) {
    showToast(errorResult);
  }
...
//                startActivity(i);
  ...
  class GetSeedInfoBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      initSeedInfoView();
      HttpService.DoGetSeedInfoRequest(ParentMainActivity.this);
    }
  }
